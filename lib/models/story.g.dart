...
mixin _$Story on StoryBase, Store {
  ...
  final _$userAtom = Atom(name: 'StoryBase.user');
  ...
  final _$timeAgoAtom = Atom(name: 'StoryBase.timeAgo');
  ...
  final _$urlAtom = Atom(name: 'StoryBase.url');
  ...
  final _$commentsCountAtom = Atom(name: 'StoryBase.commentsCount');
  ...
  final _$pointsAtom = Atom(name: 'StoryBase.points');
  ...
  final _$doneAtom = Atom(name: 'StoryBase.done');
  ...
  final _$contentAtom = Atom(name: 'StoryBase.content');
